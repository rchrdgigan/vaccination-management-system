    ...
    <div class="intro-y col-span-12 lg:col-span-12">
        ...
        <div class="intro-y box p-5">
            ...
            <div  class="mt-3">
                ...
                <input name="mother_name" type="text" class="input w-full border mt-2" placeholder="Please insert the Full name of the Mother">
            </div>
            <div  class="mt-3">
                <label>Father's Name</label>
                <input  name="father_name" type="text" class="input w-full border mt-2" placeholder="Please insert the Full name of the Father">
            </div>
            <div class="mt-3">
                <label>Date of Registration</label>
                <input name="reg_date" class="datepicker input w-full border mt-2" data-single-mode="true">
            </div>
            <div class="mt-3">
                <label>Date of Birth</label>
                <input name="birth_date"class="datepicker input w-full border mt-2" data-single-mode="true">
            </div>
            <div class="mt-3">
