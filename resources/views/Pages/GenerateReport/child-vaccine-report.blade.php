            ...
            <table id="example1" class="table table-bordered table-striped">
                ...
                @foreach($child_vaccines as $data)
                    ...
                    <tr>
                        ...
                        <td>{{ $item->vaccines_name}}</td>
                        <td>{{ $item->has_dose}}</td>
                        <td>
                            {{(isset( $item->inj_3rd_date)) ?
                            Carbon\Carbon::parse( $item->inj_3rd_date)->format('M d, Y') .' - '. ' 3rd Dose ' :
                            (isset( $item->inj_2nd_date) ? Carbon\Carbon::parse( $item->inj_2nd_date)->format('M d, Y') .' - '. ' 2nd Dose ':
                            (isset( $item->inj_1st_date) ? Carbon\Carbon::parse( $item->inj_1st_date)->format('M d, Y') .' - '. ' 1st Dose ' : 'N/A'))}}
                        </td>
                    </tr>
                    @endforeach
                @endforeach
